...
const SLOTS: SlotData[] = [
  ...
  { slotId: 'about-hero-005', page: 'about', section: 'hero', description: 'About 히어로 도쿄 이미지.', slotSize: 'medium', label: 'TOKYO' },
  { slotId: 'about-hero-006', page: 'about', section: 'hero', description: 'About 히어로 사사다 이미지.', slotSize: 'small', label: 'SASADA' },
